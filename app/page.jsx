...
export default function Portfolio() {
  ...
  const skills = [
    ...
    { name: "Node.js & Express", icon: <Server className="w-6 h-6" />, level: 88 },
    { name: "PostgreSQL (Neon) + Prisma", icon: <Database className="w-6 h-6" />, level: 85 },
  ...
  function ShieldCheckIcon() {
    return (
      <svg className="w-6 h-6" viewBox="0 0 24 24" fill="none">
        <path d="M12 3l7 3v5c0 5-3.5 9-7 10-3.5-1-7-5-7-10V6l7-3z" stroke="currentColor" strokeWidth="2" />
  ...
  function SparklesIcon() {
    return (
      <svg className="w-6 h-6" viewBox="0 0 24 24" fill="none">
        <path d="M5 8l2 4 4 2-4 2-2 4-2-4-4-2 4-2 2-4z" stroke="currentColor" strokeWidth="2" />
        <path d="M17 2l1.2 2.8L21 6l-2.8 1.2L17 10l-1.2-2.8L13 6l2.8-1.2L17 2z" stroke="currentColor" strokeWidth="2" />
      </svg>
    );
  }
  ...
  const projects = [
    {
      ...
      tech: ["Next.js", "API Routes", "PostgreSQL (Neon)", "Prisma", "NextAuth", "Tailwind CSS", "Vercel"],
    },
    {
  ...
  const blogPosts = [
    {
      ...
      excerpt: "Best practices for structuring and scaling React apps for growth.",
      date: "2024-01-15",
      readTime: "8 min read",
    },
    {
      title: "PostgreSQL + Prisma in Next.js",
      excerpt: "Schema modeling, migrations, and safe queries with Prisma on Neon.",
      date: "2024-01-08",
      readTime: "6 min read",
    },
    {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-purple-900 to-gray-900 text-white">
      ...
      <section id="home" className="min-h-screen flex items-center justify-center px-4 pt-20">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl md:text-2xl text-gray-300 mb-8 max-w-2xl mx-auto leading-relaxed">
            I build pragmatic, production-ready web apps with Next.js, Node/Express, and PostgreSQL. Clean UI, strong
            auth, and reliable data layers.
          </p>
          ...
          <div className="flex justify-center space-x-6 mt-8">
            <Link href="https://github.com/Subhan2117" className="text-gray-400 hover:text-cyan-400 transition-colors">
              <Github className="w-6 h-6" />
            </Link>
            <Link href="https://linkedin.com" className="text-gray-400 hover:text-cyan-400 transition-colors">
              <Linkedin className="w-6 h-6" />
            </Link>
            <Link href="mailto:your.email@example.com" className="text-gray-400 hover:text-cyan-400 transition-colors">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <p className="text-lg text-gray-300 leading-relaxed mb-6">
                I’m an aspiring full-stack developer focused on shipping polished, real-world apps. Recent work includes
                a role-based job tracker (HireFlow), a hardware store catalog experience, and a React SEO-focused movie
                explorer.
              </p>
              <p className="text-lg text-gray-300 leading-relaxed mb-6">
                My current toolkit: Next.js, Node/Express, PostgreSQL (Neon) with Prisma, NextAuth/Supabase for auth,
            ...
            <div className="relative">
              <div className="bg-gradient-to-br from-cyan-500/10 to-purple-500/10 p-8 rounded-2xl border border-cyan-500/20 backdrop-blur-sm">
                <h3 className="text-2xl font-semibold mb-4 text-cyan-400">Quick Facts</h3>
      ...
      <section id="contact" className="py-20 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-12">
            <div>
              <h3 className="text-2xl font-semibold mb-6 text-cyan-400">Let's Work Together</h3>
              <p className="text-gray-300 mb-6 leading-relaxed">
                Open to internships and collaborations. If you have a question or an idea, say hi!
              </p>
              <div className="space-y-4">
                ...
                <div className="flex items-center">
                  ...
                  <span className="text-gray-300">linkedin.com/in/yourprofile</span>
                </div>
              </div>
            </div>
      ...
      <footer className="py-8 px-4 border-t border-gray-800">
        <div className="max-w-4xl mx-auto text-center">
          <p className="text-gray-400">© {new Date().getFullYear()} Subhan Nadeem. Built with Next.js and lots of ☕</p>
        </div>
      </footer>
    </div>
  );
